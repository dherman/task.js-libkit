...
var T_PAUSED    = 0;  // can't be scheduled or executed
var T_STARTED   = 1;  // may or may not currently be executing
var T_CANCELLED = 2;  // cancelled but not yet done cleaning up
var T_CLOSED    = 3;  // completely done
